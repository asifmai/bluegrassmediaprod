  ...
  function u(n, c) {
    function e() {
      ...
      var e = this,
        ...
        f = arguments;
      d && (d = clearTimeout(d));
      l > n ? b() : d = setTimeout(b, n - l)
    }
    var d, j = 0;
    b.guid && (e.guid = c.guid = c.guid || b.guid++);
    return e
  }
  b.Espy = function (n, c, e) {
    function d(a) {
      if (a = v(a)) {
        var h = a.$el.offset()[a.horizontal ? "left" : "top"] - p.offset[a.horizontal ?
            "left" : "top"],
          g = a.$el[a.horizontal ? "outerWidth" : "outerHeight"]();
        b.extend(a, {
          start: h,
          elSize: g,
          end: h + g
    ...
    function j(a) {
      if (a === s) b.each(m, j);
        ...
        var h = p[a.horizontal ? "width" : "height"],
          g = t(a.size, h),
          h = p[a.horizontal ? "left" : "top"] + t(a.offset, h, -g),
          d = h + g,
          g = a.contain ? h <= a.start && d >= a.end ? "inside" : h + g / 2 > a.start + a.elSize / 2 ? a.horizontal ? "left" : "up" : a.horizontal ? "right" : "down" : h > a.start && h < a.end || d > a.start && d < a.end || h <= a.start && d >= a.start || h <= a.end && d >= a.end ? "inside" : h > a.end ? a.horizontal ?
          "left" : "up" : a.horizontal ? "right" : "down";
        a.state !== g && (a.state = g, "function" === typeof c && c.call(a.el, "inside" === g, g), "function" === typeof a.callback && a.callback.call(a.el, "inside" === g, g))
      }
    }
    ...
    var l = this,
      f = b(n),
      r = b.extend({}, b.fn.espy.defaults, e),
      m = {},
      q = 0,
      p = {
        top: f.scrollTop(),
    ...
    l.add = function (a, c, g) {
      b.isPlainObject(c) && (g = c, c = 0);
      b(a).each(function (a, e) {
        var f = k(e) || "s" + q++;
        m[f] = b.extend({
          id: f,
          el: e,
    ...
    f.on("scroll.espy", u(r.delay, function () {
      p.top = f.scrollTop();
      p.left = f.scrollLeft();
      j()
    }));
    f.on("resize.espy", u(r.delay, function () {
      p.width = f.innerWidth();
      p.height = f.innerHeight();
      j()
    }))
  };
  b.fn.espy = function (n, c) {
    var e, d, j = c && c.context || q,
      k = b.data(j, "espy") || b.data(j, "espy", new b.Espy(j));
    "string" === typeof n && (e = !1 === c || "destroy" === c ? "remove" : c, d = Array.prototype.slice.call(arguments, 1), c = {});
    return this.each(function (b, j) {
      e ? "function" === typeof k[e] && k[e].apply(k, d) : k.add(j, n, c)
    })
  };
  b.fn.espy.defaults = {
    delay: 100,
...
(function () {
  ...
  n.init = function (t) {
    ...
    t.onload = function () {
      var e = document.getElementsByClassName("retina"),
        t = [],
        r, s;
